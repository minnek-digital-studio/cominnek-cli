...
Create commits & pull requests easily.  `Cominnek` is based on [TAYO]([https://mnk-docs.ngrok.io/guide/development/version-control/branch-management.html](https://docs.minnekdigital.com/engineering/development/version-control/branch/tayo-flow.html#tayo-methodology)) by Minnek.
## Index
